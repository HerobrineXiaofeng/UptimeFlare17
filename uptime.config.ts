...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    // Example HTTP Monitor
    {
      ...
      target: 'https://herobrinexiaofeng.com',
      // [OPTIONAL] `tooltip` is ONLY used at status page to show a tooltip
      tooltip: 'https://herobrinexiaofeng.com',
      // [OPTIONAL] `statusPageLink` is ONLY used for clickable link at status page
      statusPageLink: 'https://herobrinexiaofeng.com',
    ...
    // Example HTTP Monitor
    {
      ...
      method: 'GET',
      // `target` is a valid URL
      target: 'https://shop.herobrinexiaofeng.com',
      // [OPTIONAL] `tooltip` is ONLY used at status page to show a tooltip
      tooltip: 'https://shop.herobrinexiaofeng.com',
      // [OPTIONAL] `statusPageLink` is ONLY used for clickable link at status page
      statusPageLink: 'https://shop.herobrinexiaofeng.com',
      // [OPTIONAL] `expectedCodes` is an array of acceptable HTTP response codes, if not specified, default to 2xx
      expectedCodes: [200],
      // [OPTIONAL] `timeout` in millisecond, if not specified, default to 10000
      timeout: 10000,
    ...
    // Example HTTP Monitor
    {
      ...
      method: 'GET',
      // `target` is a valid URL
      target: 'https://herobrinexiaofeng.cn',
      // [OPTIONAL] `tooltip` is ONLY used at status page to show a tooltip
